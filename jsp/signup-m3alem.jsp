...
<body>
<a class="a-retour-acceuil" href="/Projet_PFE/jsp/pre-signup.jsp"><i class="fa-solid fa-circle-arrow-left fa-retour-acceuil"></i></a>
            ...
            <div class="formbg-outer">
                <div class="formbg">
                    <div class="formbg-inner padding-horizontal--48">
                        ...
                        <form enctype="multipart/form-data" id="stripe-login" method="post" action="/Projet_PFE/m3almsignin">
...
<!--                            </div>-->
                            ...
                            <div class="field padding-bottom--24">
                                ...
                                <select id="field padding-bottom--24" Name="specialty">
                            ...
                            <div class="field padding-bottom--24">
                                <label>City :</label>
                                <select id="select-city" name="ville">
